...
VALUES
('client', '{bcrypt}$12$JCzlOjEfkCiuHRT6sdMyHu8lWLI2H.02qdt75Oe6XVH7NsHMACl0q', 'http://localhost:8000/login', 'READ,WRITE', '3600', '10000', 'library-book,library-loan', 'authorization_code,password,refresh_token,implicit', 'true', '{}'),
('batch', '{bcrypt}$12$JCzlOjEfkCiuHRT6sdMyHu8lWLI2H.02qdt75Oe6XVH7NsHMACl0q', 'http://localhost:9005/login', 'READ', '3600', '10000', 'library-loan', 'client_credentials', 'true', '{}');
...
(2, 'user', 'Paul', 'Lastname', '{bcrypt}$2y$12$dspd2mG2WbRCo0CI2e92vOe1JxnOv.V4Pvp2e2drjN.kofrkkaJnG', 'user@aaa.com', '0222222222', 'USER', '1', '1', '1', '1' ),
